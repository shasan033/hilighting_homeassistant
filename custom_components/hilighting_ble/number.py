...
async def async_setup_entry(
    ...
    async_add_entities([HiLightingSpeedSlider(instance, "Effect speed", config_entry.entry_id)])

class HiLightingSpeedSlider(NumberEntity):
    def __init__(self, hilightingInstance: HILIGHTINGInstance, attr_name: str, entry_id: str) -> None:
